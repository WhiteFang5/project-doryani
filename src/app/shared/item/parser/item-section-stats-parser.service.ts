...
import { ExportedItem, Item, ItemCategory, ItemRarity, ItemSection, ItemSectionParserService, Section } from '@shared/item/type';
import { StatsService } from '@shared/stats/service';
import { StatsSearchOptions } from '@shared/stats/type';
...
export class ItemSectionStatsParserService implements ItemSectionParserService {
	...
	private createOptions(item: Item): StatsSearchOptions {
		const options: StatsSearchOptions = {
			sanctum: item.category === ItemCategory.SanctumRelic,
