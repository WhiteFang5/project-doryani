...
import { ExportedItem, Item, ItemRequirements, ItemSection, ItemSectionParserService, Section } from '@shared/item/type';
...
export class ItemSectionRequirementsParserService implements ItemSectionParserService {
	...
	private parseSimpleValue(line: string, phrase: string, value: number | undefined): number | undefined {
